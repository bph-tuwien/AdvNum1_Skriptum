...
brick = [0] * 15
brick = [Cell_Mat(dx=0.1 / 15, lamb=0.23, mu=1.1 * 1e-7, cp=1000, rho=2800, Tn=20, pv=1000, Lv=2400 * 1e3, kw_lamb=6,
...
BC_left = [Cell_Mat(dx=0.1 / 15, lamb=0.23, mu=1.1 * 1e-7, cp=1000, rho=2800, Tn=20, pv=1200, Lv=2400 * 1e3, kw_lamb=6,
                    kw_mu=-1.57 * 1e-7)]
BC_right = [Cell_Mat(dx=0.1 / 15, lamb=0.23, mu=1.1 * 1e-7, cp=1000, rho=2800, Tn=20, pv=1200, Lv=2400 * 1e3, kw_lamb=6,
                     kw_mu=-1.57 * 1e-7)]
...
def fc_coupled_HAM(vec_Tpvp, vec_Tpv, dt):
    # split array
